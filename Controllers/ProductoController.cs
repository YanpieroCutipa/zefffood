...
namespace zefffood.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Status,ImageURL,Description")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Status,ImageURL,Description")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
